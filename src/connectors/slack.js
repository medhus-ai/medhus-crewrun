...
export const slackConnectorActions = Object.freeze([
  Object.freeze({
    ...
    description: "Post plain text to a Slack channel. The host must approve delivery.",
    scopes: ["chat:write"],
  ...
  Object.freeze({
    ...
    description: "Reply with plain text in the thread of an existing Slack app mention. The host must approve delivery.",
