...
// A role's settings come from its spec (<crew>/roles/<role>.json merged over _defaults.json,
// with legacy .md frontmatter honored when no .json exists) — see role-spec.js.
